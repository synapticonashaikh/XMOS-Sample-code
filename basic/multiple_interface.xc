 ...
 * ----------------------------------------------------------------------------
*/
       interface my_interface0 {  void fA ( int x , int y ); };
       interface my_interface1 {  void fB ( float x ); };         
...
void task1(client interface my_interface0 i)
{
    i.fA(5 , 10) ; 
}

void task2(client interface my_interface1 j)
{
    j.fB(10.10) ; 
}


void task3(server interface my_interface0 i,
           server interface my_interface1 j)
{
...
int main( )
{
    ...
    interface my_interface0 i;
    interface my_interface1 j;
