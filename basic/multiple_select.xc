...
select SelectFunction(chanend c, TIMER0 &TIM)
{

    case c :> UNION8 UN:
         printf("DATA=%u\n\r",UN.ui64);
         break;
    case t when timerafter (TIM.uiCompareTime) :> void:
         TIM.TimerFlag.uiTime1SecFlag = SET ;
...
void Task1(void)
{
    ...
    TIMER0 TIM;
     ...
     TIM.stTime :> TIM.uiCompareTime ;
     TIM.uiCompareTime = TIM.uiCompareTime + ui1Sec ;

     printf("here1\n\r");
     SelectFunction (c, TIM );
     printf("here2\n\r");
