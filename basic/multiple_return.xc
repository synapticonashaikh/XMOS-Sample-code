 ...
 **************************************************************************************
 ...
 ______________________________________________________________________________________
  ...
  Summary:
  This file contains the source code for testing mutiple return of a function. 
 ______________________________________________________________________________________
...
*/
    ...
    uint8_t uiVariableA = (uint8_t)5 ;
    uint8_t uiVariableB = (uint8_t)10;
 ...
 * Arguments	  : int uiVariableA, int uiVariableB
 * Return Type	: int, int
 * Details	    : swap the arguments
 * *********************************************************************/
{int, int} Function1(int uiVariableA, int uiVariableB)
{

    printf (" In function DATA A=%d\tDATA B=%d\n\r",uiVariableA,uiVariableB);
    return {uiVariableB, uiVariableA};
...
*/
	...
	//xcc -target=XCORE-200-EXPLORER file_location/multiple_return.xc -o output_location/multi_ret.xe
	//xsim output_location/multi_ret.xe
	//xrun --io output_location/multi_ret.xe 
...
int main ( )
{
    ...
    {uiVariableA, uiVariableB} = Function1 (uiVariableA,uiVariableB);
    printf ("Out function DATA A=%d\tDATA B=%d\n\r",uiVariableA,uiVariableB);
