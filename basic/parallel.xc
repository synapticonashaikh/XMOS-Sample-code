 ...
 * Arguments	: int uiVariableA
 * Return Type	: void
 * Details	    : print the number
 * *********************************************************************/
void Function1(int uiVariableA)
{
 ...
 * ----------------------------------------------------------------------------
*/
	//xcc -target=XCORE-200-EXPLORER file_location/parallel.xc -o output_location/parallel.xe
	//xsim output_location/parallel.xe
	//xrun --io output_location/parallel.xe
...
int main ( ) 
{
	...
	par 
	{
		Function1 ((uint8_t)0) ;		Function1 ((uint8_t)1) ;		Function1 ((uint8_t)2) ; 
		Function1 ((uint8_t)3) ;		Function1 ((uint8_t)4) ;		Function1 ((uint8_t)5) ; 
		Function1 ((uint8_t)6) ;		Function1 ((uint8_t)7) ;	    
